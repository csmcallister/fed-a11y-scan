...
#     from lambdas.current_domain_gatherer import handler
...
# def test_grouper():
#     from lambdas.current_domain_gatherer.handler import grouper
...
#     from lambdas.current_domain_gatherer.handler import send_sqs_messages
